...
//        intent.putExtra("main_province", user.getSchoolCity());
        tabHost.addTab(spec);
        ...
        mRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.main_tab_lost_info: //失物信息
                        ...
                        break;
                    case R.id.main_tab_found_info:  //招领信息
                        ...
                        ivChoseLocation.setVisibility(View.VISIBLE);
                        break;
                    case R.id.main_tab_publish_info: //发布信息
                        ...
                        break;
                    case R.id.main_tab_notify:  //我的通知
                        ...
                        ivChoseLocation.setVisibility(View.INVISIBLE);
                        break;
                    case R.id.main_tab_person_central://个人中心
